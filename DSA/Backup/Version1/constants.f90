...
real*8,parameter::xmin=0.0,xmax=1.0,cour=0.8
...
real*8::lambda(0:nx,3)
!----------------------------------------------------------------
!----------------------------------------------------------------
integer,parameter::meshType=2 !1:uniform, 2:logarithmic
integer,parameter::testType=0 !0,1,2,3
integer,parameter::methodType=4 !1:C-C Fully Implicit, 2:C-C Semi-Implicit (Crank-Nicholson) 3:Simple Explicit, 4:Simple Implicit

real*8::Pc(-1:nx+2),dudx(nx)
